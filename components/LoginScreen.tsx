...
const LoginScreen: React.FC<LoginScreenProps> = ({ onRoleSelect }) => {
  return (
    <div className="flex-grow flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-gray-50 dark:from-gray-800 dark:to-gray-900 p-4">
      <div className="w-full max-w-lg text-center bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
        <div className="mb-6">
        ...
        <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-2">전남대학교 장학금 AI 도우미</h1>
